...
public class BannerExVO {
	...
	public String toString() {
		return "BannerExVO [adsNo=" + adsNo + ", expertNo=" + expertNo + ", categoryNo=" + categoryNo
				+ ", requestPeriod=" + requestPeriod + ", startDate=" + startDate + ", endDate=" + endDate + ", price="
				+ price + ", fileName=" + fileName + ", originalFileName=" + originalFileName + ", fileSize=" + fileSize

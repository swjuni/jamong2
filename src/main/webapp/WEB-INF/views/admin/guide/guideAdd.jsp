                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="frmWrite" method="post" action="<c:url value='/admin/guide/guideAdd.do'/>">
                                        	<fieldset>
												<legend></legend>
	                                            <div class="form-group">
						            				<input type="text" id="pageName" name="pageName" class="form-control input-default"
						            				 maxlength="100" placeholder="페이지명을 입력하세요" required="required"/>
	                                            </div>
	                                            
										        <div class="form-group">  
										 			<textarea id="content" name="content" class="form-control" style="width: 100%"></textarea>
										        </div>
												<script type="text/javascript">
													//스마트에디터2 생성 코드
													var oEditors = [];

                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="frmWrite" method="post" action="<c:url value='/admin/categoryl/categoryEdit.do'/>" enctype="multipart/form-data">
                                        	<fieldset>
												<legend></legend>
	                                            <div class="form-group">
						            				<input type="text" id="categoryNameL" name="categoryNameL" class="form-control input-default" 
						            				maxlength="100" placeholder="제목을 입력하세요." required="required" value="${vo.categoryNameL }"/>
	                                            </div>

                                ...
                                <div class="card-body">
									<div class="user-profile">
                    					<div class="row">
                    						...
                    						<div class="col-lg-12">
                    							<div class="user-profile-name">관리자 배너 설명 가져오기</div>
                    						</div>
									...
									<div class="text-center">
							            ...
							            onclick="location.href='<c:url value='/admin/bannermanager/bannerDetail.do'/>'">&nbsp;&nbsp;
							            <input type = "button" value="비활성화" class="btn btn-primary"
							            onclick="location.href='<c:url value='/admin/bannermanager/bannerDetail.do'/>'">&nbsp;&nbsp;
							            <input type = "Button" value="수정" class="btn btn-primary"
				            			onclick="location.href='<c:url value='/admin/bannermanager/bannerEdit.do'/>'">&nbsp;&nbsp;
							            <input type = "Button" value="삭제" class="btn btn-primary"
				            			onclick="location.href='<c:url value='/admin/bannermanager/bannerDelete.do'/>'">&nbsp;&nbsp;

                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="frmWrite" method="post" action="<c:url value='/admin/bannermanager/bannerEdit.do'/>" enctype="multipart/form-data">
                                        	<fieldset>
												<legend></legend>
	                                            <div class="form-group">
						            				<input type="text" id="title" name="title" class="form-control input-default" maxlength="100" placeholder="관리자 배너명 불러오기(수정가능)" required="required"/>
	                                            </div>
	                                            
	                                            <div>
												광고기간 선택 : 
													<select name="categoryl">
														<option value="itpro">30일</option>
														<option value="youtube">60일</option>
														<option value="youtube">90일</option>
													</select>
													&nbsp;&nbsp;
												활성화 여부 :
													<select name="categoryl">
														<option value="itpro">활성화</option>
														<option value="youtube">비 활성화</option>
													</select>
												</div><br>
												<div class="form-group">
						            				광고 시작일 : <input type="text" id="title" name="title" class="form-control input-default" maxlength="100" placeholder="광고 시작일을 입력하세요" required="required"/>
	                                            </div>
												...
												<div class="text-center">
										            ...
										            onclick="location.href='<c:url value='/admin/bannermanager/bannerList.do'/>'">
										        </div>

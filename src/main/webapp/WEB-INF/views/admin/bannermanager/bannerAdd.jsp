                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form name="frmWrite" method="post" action="<c:url value='/admin/bannermanager/bannerAdd.do'/>" enctype="multipart/form-data">
                                        	<fieldset>
												<legend></legend>
	                                            <div class="form-group">
						            				<input type="text" id="title" name="title" class="form-control input-default" maxlength="100" placeholder="관리자 배너명을 입력하세요" required="required"/>
	                                            </div>
	                                            <div>
												광고기간 선택 : 

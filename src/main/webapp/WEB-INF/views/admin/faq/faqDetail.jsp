...
<script type="text/javascript">
	$(document).ready(function(){
		$('#del').click(function(){
			if(confirm("삭제하시겠습니까?")){
				location.href="<c:url value='/admin/faq/faqDelete.do?faqNo=${vo.faqNo }'/>";
			}else{  //삭제 취소
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
									<div class="user-profile">
                    					<div class="row">
                   							<div class="user-profile-name">${vo.faqTitle }</div>
                    						<div class="col-lg-12">
                    							<div style="float: left;"><span>${vo.adminNo }</span>&nbsp;&nbsp;|&nbsp;&nbsp;<span><fmt:formatDate value="${vo.faqRegdate }" pattern="yyyy-MM-dd HH-mm-ss"/> </span></div>
                    							<br>
                    							<hr>
                    							<br>
                   								${vo.faqContent }
									...
									<div class="text-center">
							            ...
							            onclick="location.href='<c:url value='/admin/faq/faqEdit.do?faqNo=${vo.faqNo }'/>'">&nbsp;&nbsp;
